...
public class DashboardTest2 extends TestBase {
    ...
    public void verifyList() {
        ...
        System.out.println("actualList = " + actualList);// actualList = [Developers, All Posts, My Account]
        System.out.println("expectedList = " + expectedList);// expectedList = [Developers, All Posts, My Account]
